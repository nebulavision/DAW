# Unidad de Trabajo 3: Modelo de objetos predefinidos en Javascript
...
### Actividad 8. Analiza los siguientes código. A continuación, programa tu propio generador de historias aleatorias:
```
<!DOCTYPE html>
